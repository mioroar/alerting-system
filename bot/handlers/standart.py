...
• <code>/price [> или <] [процент] [интервал_сек]</code> — подписка на изменение цены
  Пример: <code>/price > 5 60</code> (уведомление при изменении цены больше 5% за 60 сек)
...
• <code>/volume_amount [> или <] [сумма_USD] [интервал_сек]</code> — подписка на объём
  Пример: <code>/volume_amount > 10000000 300</code> (объём больше 10M USD за 300 сек)
...
• <code>/volume [> или <] [процент] [интервал_сек]</code> — подписка на изменение объёма
  Пример: <code>/volume > 50 60</code> (увеличение объёма больше 50% за 60 сек)
